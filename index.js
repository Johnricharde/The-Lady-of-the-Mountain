...
function barkeep() {
    ...
    buttons = /*HTML*/`
    <button onclick="barkeepAboutLady()">Ask about the Lady of the Mountain</button><br>
    <button>Request a Strong Drink</button><br>
    <button>Share a tale of your quest</button>
    `
    updateScreen()
}
function barkeepAboutLady() {
    ...
    buttons = /*HTML*/`
        <button onclick="barkeepSeekAdvice()">Seek advice for the ascent</button><br>
        <button>Ask about his own journey</button><br>
        <button>Leave</button>
    `
    updateScreen()
}
function barkeepSeekAdvice() {
    ...
    buttons = /*HTML*/`
        <button onclick="barkeepAcceptQuest()">Accept</button><br>
        <button>Decline</button>
    `
     updateScreen()
    }
function barkeepAcceptQuest() {
...
function orbApproach() {
    ...
    buttons = /*HTML*/`
        <button onclick="orbTake()">Take the orb</button>
...
function orbTake() {
    ...
    buttons = /*HTML*/`
        <button onclick="loneWolf()">Continue</button>
    `
     updateScreen()
}
function loneWolf() {
    ...
    buttons = /*HTML*/`
        <button onclick="wolfFight()">Fight</button>
...
function wolfFight() {
    ...
    buttons = /*HTML*/`
        <button onclick="campForest()">Continue</button>
    `
     updateScreen()
}
function campForest() {
...
function runestones() {
    ...
    buttons = /*HTML*/`
        <button onclick="runestonesApproach()">Approach Peacefully</button>
        <button>Interrupt the Ritual</button>
        <button>Observe in Silence</button>
    `
     updateScreen()
}
function runestonesApproach() {
    ...
    buttons = /*HTML*/`
        <button onclick="runestonesAskAbout()">Ask about the runestones</button>
        <button>Seek guidance</button>
        <button>Gift a token</button>
    `
     updateScreen()
}
function runestonesAskAbout() {
    ...
    buttons = /*HTML*/`
        <button onclick="runestonesAskAbout2()">Continue</button>
    `
     updateScreen()
}
function runestonesAskAbout2() {
    ...
    buttons = /*HTML*/`
        <button onclick="runestonesAboutLady()">Ask about the Lady of the Mountain</button>
        <button>Ask about his own travels</button>
        <button>Ask why he is here</button>
    `
     updateScreen()
}
function runestonesAboutLady() {
...
function caveTunnelPressOn() {
    ...
    buttons = /*HTML*/`
        <button onclick="trollTorch()">Light a torch</button>
...
function trollTorch() {
    ...
    buttons = /*HTML*/`
        <button onclick="caveHole()">Leave the troll</button>
...
function caveHole() {
    ...
    buttons = /*HTML*/`
        <button onclick="caveHoleExit()">Continue</button>
    `
     updateScreen()
}
function caveHoleExit() {
    ...
    buttons = /*HTML*/`
        <button onclick="nearSummit()">Continue</button>
    `
     updateScreen()
}
